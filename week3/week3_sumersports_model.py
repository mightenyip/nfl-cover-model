...
def run_week3_sumersports_model():
    ...
    week3_odds_path = "week3_2025_odds.csv"
    ...
    # Save predictions
    week3_data.to_csv("week3_sumersports_predictions.csv", index=False)
    print(f"\n✅ Predictions saved to: week3_sumersports_predictions.csv")

    return week3_data

if __name__ == "__main__":
    run_week3_sumersports_model()
