...
def run_model_b_v2_week7():
    """Run Model B v2 for Week 7 using matchup-specific EPA analysis"""
    ...
    week7_data['fav_pass_vs_underdog_pass_def'] = week7_data['favorite_epa_pass_off'] - week7_data['underdog_epa_pass_def']
    week7_data['fav_rush_vs_underdog_rush_def'] = week7_data['favorite_epa_rush_off'] - week7_data['underdog_epa_rush_def']
    week7_data['underdog_pass_vs_fav_pass_def'] = week7_data['underdog_epa_pass_off'] - week7_data['favorite_epa_pass_def']
    week7_data['underdog_rush_vs_fav_rush_def'] = week7_data['underdog_epa_rush_off'] - week7_data['favorite_epa_rush_def']
    
    # Overall matchup advantages
    week7_data['favorite_pass_advantage'] = week7_data['fav_pass_vs_underdog_pass_def']
    week7_data['favorite_rush_advantage'] = week7_data['fav_rush_vs_underdog_rush_def']
    week7_data['underdog_pass_advantage'] = week7_data['underdog_pass_vs_fav_pass_def']
    week7_data['underdog_rush_advantage'] = week7_data['underdog_rush_vs_fav_rush_def']
    
    # Net matchup differentials
    week7_data['net_pass_advantage'] = week7_data['favorite_pass_advantage'] - week7_data['underdog_pass_advantage']
    week7_data['net_rush_advantage'] = week7_data['favorite_rush_advantage'] - week7_data['underdog_rush_advantage']
    ...
    week7_data['cover_probability'] += week7_data['underdog_total_advantage'] * 2.0

    # Adjust based on favorite's total advantage (negative for underdog)
    week7_data['cover_probability'] -= week7_data['favorite_total_advantage'] * 1.5

    # Pass vs Rush balance analysis
    week7_data['pass_rush_balance'] = abs(week7_data['net_pass_advantage'] - week7_data['net_rush_advantage'])
    week7_data['cover_probability'] += week7_data['pass_rush_balance'] * 0.5

    # Spread adjustment
    week7_data['cover_probability'] += week7_data['spread_line'].abs() * 0.01
    ...
    week7_data['outright_win_probability'] = week7_data['cover_probability'] * 0.65
    week7_data['outright_win_probability'] = week7_data['outright_win_probability'].clip(0.03, 0.80)
    ...
    print(f"\n=== Week 7 Model B v2 Predictions ===")
    
    # Show detailed matchup analysis for top games
    top_games = week7_data.sort_values(by='cover_probability', ascending=False).head(5)
    ...
    # Save predictions
    week7_data.to_csv("model_b_v2_week7_predictions.csv", index=False)
    print(f"✅ Model B v2 Week 7 predictions saved to: model_b_v2_week7_predictions.csv")
