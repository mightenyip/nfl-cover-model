#!/usr/bin/env python3
"""
Model B Comprehensive Performance Analysis
Analyzes Model B performance from Week 2 onward through Week 7
"""

import pandas as pd
import numpy as np

def analyze_model_b_comprehensive():
    """Analyze Model B performance from Week 2 through Week 7"""
    
    print("=== Model B Comprehensive Performance Analysis ===")
    print("Analyzing Model B performance from Week 2 through Week 7")
    print("=" * 70)
    ...
    week3_data = {
        ...
        'Texans @ Jaguars': {'prediction': 'Cover', 'underdog_covered': False, 'correct': False, 'spread': 1.5},
        'Bengals @ Vikings': {'prediction': 'Cover', 'underdog_covered': False, 'correct': False, 'spread': 3.0},
        'Steelers @ Patriots': {'prediction': 'Cover', 'underdog_covered': False, 'correct': False, 'spread': 1.5},
        'Rams @ Eagles': {'prediction': 'Cover', 'underdog_covered': False, 'correct': False, 'spread': 3.5},
        'Jets @ Buccaneers': {'prediction': 'Cover', 'underdog_covered': True, 'correct': True, 'spread': 7.0},
        'Colts @ Titans': {'prediction': 'Cover', 'underdog_covered': False, 'correct': False, 'spread': 3.5},
        'Raiders @ Commanders': {'prediction': 'Cover', 'underdog_covered': False, 'correct': False, 'spread': 3.5},
        'Broncos @ Chargers': {'prediction': 'Cover', 'underdog_covered': False, 'correct': False, 'spread': 2.5},
        'Saints @ Seahawks': {'prediction': 'Cover', 'underdog_covered': False, 'correct': False, 'spread': 7.5},
        'Cowboys @ Bears': {'prediction': 'Cover', 'underdog_covered': False, 'correct': False, 'spread': 1.5},
        'Cardinals @ 49ers': {'prediction': 'Cover', 'underdog_covered': True, 'correct': True, 'spread': 1.5},
        'Chiefs @ Giants': {'prediction': 'Cover', 'underdog_covered': False, 'correct': False, 'spread': 6.5},
    ...
    week7_data = {
        ...
        'Rams @ Jaguars': {'prediction': 'Cover', 'underdog_covered': False, 'correct': False, 'spread': 3.0},
        'Saints @ Bears': {'prediction': 'Cover', 'underdog_covered': False, 'correct': False, 'spread': 5.5},
        'Dolphins @ Browns': {'prediction': 'Cover', 'underdog_covered': False, 'correct': False, 'spread': 2.5},
        'Patriots @ Titans': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 7.0},
        'Raiders @ Chiefs': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 11.5},
        'Eagles @ Vikings': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 2.5},
        'Panthers @ Jets': {'prediction': 'Cover', 'underdog_covered': False, 'correct': False, 'spread': 1.5},
        'Giants @ Broncos': {'prediction': 'Cover', 'underdog_covered': True, 'correct': True, 'spread': 7.0},
        'Colts @ Chargers': {'prediction': 'Cover', 'underdog_covered': True, 'correct': True, 'spread': 1.5},
        'Commanders @ Cowboys': {'prediction': 'Cover', 'underdog_covered': False, 'correct': False, 'spread': 2.5},
        'Packers @ Cardinals': {'prediction': 'No Cover', 'underdog_covered': True, 'correct': False, 'spread': 6.5},
        'Falcons @ 49ers': {'prediction': 'Cover', 'underdog_covered': False, 'correct': False, 'spread': 2.5},
        'Buccaneers @ Lions': {'prediction': 'Cover', 'underdog_covered': False, 'correct': False, 'spread': 4.5},
        'Texans @ Seahawks': {'prediction': 'Cover', 'underdog_covered': False, 'correct': False, 'spread': 3.5}
    }
    ...
    print(f"  - When Model B predicted underdog cover: {total_cover_underdog_covers}/{total_cover_predictions} actually covered ({total_cover_underdog_covers/total_cover_predictions*100:.1f}%)")
    print(f"'No Cover' Predictions: {no_cover_accuracy:.1f}% accuracy")
    print(f"  - When Model B predicted favorite cover: {total_no_cover_underdog_covers}/{total_no_cover_predictions} underdogs actually covered ({total_no_cover_underdog_covers/total_no_cover_predictions*100:.1f}%)")
    ...
    print(f"Model B Overall Accuracy: {overall_accuracy:.1f}%")
    
    if overall_accuracy > 52.7:
        print("✅ Model B outperformed Model A")
    elif overall_accuracy < 52.7:
        print("❌ Model B underperformed Model A")
    else:
        print("⚖️ Model B performed similarly to Model A")
    
    return weekly_stats

if __name__ == "__main__":
    analyze_model_b_comprehensive()
