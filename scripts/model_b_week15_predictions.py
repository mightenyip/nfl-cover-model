#!/usr/bin/env python3
"""
Model B Week 15 Predictions
Generate Model B predictions for Week 15 using Week15 EPA data
"""
...
def calculate_model_b_predictions(epa_df, odds_df):
    """Calculate Model B predictions for Week 15"""
...
def main():
    """Main function"""
    print("=== Model B Week 15 Predictions ===")
    ...
    output_file = "models/model_b/model_b_week15_predictions.csv"
    ...
    print(f"=== Model B Week 15 Summary ===")
    ...
    print(f"\n✅ Model B Week 15 predictions saved to {output_file}")
