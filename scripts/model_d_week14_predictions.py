#!/usr/bin/env python3
"""
Model D Week 14 Predictions
Generate Model D predictions for Week 14 using total-based rules
"""
...
def calculate_model_d_predictions(odds_df):
    """Calculate Model D predictions for Week 14 - Total-based rules"""
...
def main():
    """Main function"""
    print("=== Model D Week 14 Predictions ===")
    print("Generating predictions using total-based rules")
    print("=" * 60)
    
    # Load data
    odds_df = load_week14_odds()
    if odds_df is None:
        return
    ...
    output_file = "models/model_d/model_d_week14_predictions.csv"
    ...
    print(f"=== Model D Week 14 Summary ===")
    ...
    print(f"\n✅ Model D Week 14 predictions saved to {output_file}")
