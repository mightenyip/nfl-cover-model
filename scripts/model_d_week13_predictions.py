#!/usr/bin/env python3
"""
Model D Week 13 Predictions
Generate Model D predictions for Week 13 using total-based rules
"""
...
def calculate_model_d_predictions(odds_df):
    """Calculate Model D predictions for Week 13 - Total-based rules"""
...
def main():
    """Main function"""
    print("=== Model D Week 13 Predictions ===")
    ...
    output_file = "models/model_d/model_d_week13_predictions.csv"
    ...
    print(f"=== Model D Week 13 Summary ===")
    ...
    print(f"\n✅ Model D Week 13 predictions saved to {output_file}")
