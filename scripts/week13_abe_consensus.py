#!/usr/bin/env python3
"""
Week 13 Consensus Predictions for Models A, B, and E only
"""
...
def main():
    ...
    df = pd.read_csv("week13_all_models_predictions.csv")
    ...
    # Save to CSV
    output_file = "week13_abe_consensus_predictions.csv"
