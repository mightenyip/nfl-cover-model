#!/usr/bin/env python3
"""
Analyze Model A v2 performance over past 3 weeks (Weeks 4, 5, 6)
...
def analyze_model_a_v2_3_weeks():
    """Analyze Model A v2 performance across Weeks 4, 5, and 6"""
    
    print("=== Model A v2 Performance Analysis - 3 Weeks ===")
    print("Analyzing underdog cover rates and accuracy across Weeks 4, 5, 6")
    print("=" * 70)
    
    # Week 4 data (hypothetical - would need actual results)
    week4_data = {
        'Game1': {'prediction': 'Cover', 'underdog_covered': True, 'correct': True, 'spread': 3.5},
        'Game2': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 7.0},
        'Game3': {'prediction': 'Cover', 'underdog_covered': True, 'correct': True, 'spread': 4.0},
        'Game4': {'prediction': 'No Cover', 'underdog_covered': True, 'correct': False, 'spread': 2.5},
        'Game5': {'prediction': 'Cover', 'underdog_covered': False, 'correct': False, 'spread': 6.0},
        'Game6': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 5.5},
        'Game7': {'prediction': 'Cover', 'underdog_covered': True, 'correct': True, 'spread': 3.0},
        'Game8': {'prediction': 'No Cover', 'underdog_covered': True, 'correct': False, 'spread': 4.5},
        'Game9': {'prediction': 'Cover', 'underdog_covered': False, 'correct': False, 'spread': 7.5},
        'Game10': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 2.0},
        'Game11': {'prediction': 'Cover', 'underdog_covered': True, 'correct': True, 'spread': 5.0},
        'Game12': {'prediction': 'No Cover', 'underdog_covered': True, 'correct': False, 'spread': 3.5},
        'Game13': {'prediction': 'Cover', 'underdog_covered': True, 'correct': True, 'spread': 4.5},
        'Game14': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 6.5},
        'Game15': {'prediction': 'Cover', 'underdog_covered': False, 'correct': False, 'spread': 1.5}
    }
    
    # Week 5 data (hypothetical - would need actual results)
    week5_data = {
        'Game1': {'prediction': 'Cover', 'underdog_covered': True, 'correct': True, 'spread': 4.0},
        'Game2': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 8.0},
        'Game3': {'prediction': 'Cover', 'underdog_covered': False, 'correct': False, 'spread': 3.5},
        'Game4': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 5.5},
        'Game5': {'prediction': 'Cover', 'underdog_covered': True, 'correct': True, 'spread': 2.5},
        'Game6': {'prediction': 'No Cover', 'underdog_covered': True, 'correct': False, 'spread': 6.0},
        'Game7': {'prediction': 'Cover', 'underdog_covered': True, 'correct': True, 'spread': 4.5},
        'Game8': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 3.0},
        'Game9': {'prediction': 'Cover', 'underdog_covered': False, 'correct': False, 'spread': 7.0},
        'Game10': {'prediction': 'No Cover', 'underdog_covered': True, 'correct': False, 'spread': 2.0},
        'Game11': {'prediction': 'Cover', 'underdog_covered': True, 'correct': True, 'spread': 5.5},
        'Game12': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 4.0},
        'Game13': {'prediction': 'Cover', 'underdog_covered': True, 'correct': True, 'spread': 3.5},
        'Game14': {'prediction': 'No Cover', 'underdog_covered': True, 'correct': False, 'spread': 6.5},
        'Game15': {'prediction': 'Cover', 'underdog_covered': False, 'correct': False, 'spread': 1.5}
    }
