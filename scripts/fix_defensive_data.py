...
def main():
    ...
    # Save the data
    defensive_df.to_csv('data/updated_defensive_epa_data_fixed.csv', index=False)
    print(f"✅ Saved corrected defensive EPA data to data/updated_defensive_epa_data_fixed.csv")
