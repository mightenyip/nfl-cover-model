#!/usr/bin/env python3
"""
Model B Week 12 Predictions
Generate Model B predictions for Week 12 using the latest EPA data
"""
...
def load_epa_data():
    ...
    try:
        epa_df = pd.read_csv("data/epa/week11/Week11_EPA.csv")
        print(f"Loaded EPA data for {len(epa_df)} teams")
        return epa_df
    except FileNotFoundError:
        print("❌ Error: data/epa/week11/Week11_EPA.csv not found")
        return None
...
def calculate_model_b_predictions(epa_df, odds_df):
    """Calculate Model B predictions for Week 12"""
    
    print("\n=== Model B Week 12 Predictions ===")
    print("Using 5-tier defense classification and EPA analysis")
    print("=" * 60)
...
def main():
    """Main function"""
    print("=== Model B Week 12 Predictions ===")
    print("Generating predictions using 5-tier defense classification")
    print("=" * 60)
    ...
    output_file = "models/model_b/model_b_week12_week11epa_predictions.csv"
    ...
    print(f"=== Model B Week 12 Summary ===")
    ...
    print(f"\n✅ Model B Week 12 predictions saved to {output_file}")
