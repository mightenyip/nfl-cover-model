#!/usr/bin/env python3
"""
Model C Week 14 Predictions
Generate Model C predictions for Week 14 using spread-based rules
"""
...
def calculate_model_c_predictions(odds_df):
    """Calculate Model C predictions for Week 14 - Spread-based rules"""
...
def main():
    """Main function"""
    print("=== Model C Week 14 Predictions ===")
    ...
    output_file = "models/model_c/model_c_week14_predictions.csv"
    ...
    print(f"=== Model C Week 14 Summary ===")
    ...
    print(f"\n✅ Model C Week 14 predictions saved to {output_file}")
