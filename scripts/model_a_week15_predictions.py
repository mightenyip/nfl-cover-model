#!/usr/bin/env python3
"""
Model A Week 15 Predictions
Generate Model A predictions for Week 15 using Week15 EPA data
"""
...
def calculate_model_a_predictions(epa_df, odds_df):
    """Calculate Model A predictions for Week 15"""
    
    print("\n=== Model A Week 15 Predictions ===")
    print("Using Week 15 EPA data and 5-tier defense classification")
    print("=" * 60)
...
def main():
    """Main function"""
    print("=== Model A Week 15 Predictions ===")
    print("Generating predictions using Week 15 EPA data")
    print("=" * 60)
    ...
    output_file = "models/model_a/model_a_week15_predictions.csv"
    ...
    print(f"=== Model A Week 15 Summary ===")
    ...
    print(f"\n✅ Model A Week 15 predictions saved to {output_file}")
