#!/usr/bin/env python3
"""
Manual EPA Update - Extract latest EPA data from SumerSports website
"""
...
def create_updated_epa_data():
    """Create updated EPA data based on SumerSports website data"""
    ...
    df['source'] = 'sumersports_defensive_manual'
...
def main():
    """Main function to create updated EPA data"""
    
    print("=== Manual EPA Data Update ===")
    
    # Create updated defensive data
    ...
    print(f"\n✅ Successfully created updated defensive EPA data!")
    print(f"📊 Data includes {len(defensive_df)} teams with latest EPA/Pass and EPA/Rush defensive statistics")
