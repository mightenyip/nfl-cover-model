#!/usr/bin/env python3
"""
Model A Week 14 Predictions
Generate Model A predictions for Week 14 using Week14 EPA data
"""
...
def load_epa_data():
    ...
    try:
        epa_df = pd.read_csv("data/epa/week14/Week14_EPA.csv")
        print(f"Loaded EPA data for {len(epa_df)} teams")
        return epa_df
    except FileNotFoundError:
        print("❌ Error: data/epa/week14/Week14_EPA.csv not found")
        return None
...
def calculate_model_a_predictions(epa_df, odds_df):
    """Calculate Model A predictions for Week 14"""
...
def main():
    """Main function"""
    print("=== Model A Week 14 Predictions ===")
    print("Generating predictions using Week 14 EPA data")
    print("=" * 60)
    ...
    output_file = "models/model_a/model_a_week14_predictions.csv"
    ...
    print(f"=== Model A Week 14 Summary ===")
    ...
    print(f"\n✅ Model A Week 14 predictions saved to {output_file}")
