...
def create_updated_epa_data():
    ...
    # Source: https://sumersports.com/teams/offensive/ as of 10-07-2025
    offensive_data = {
        'IND': {'name': 'Indianapolis Colts', 'epa_off': 0.19, 'epa_pass_off': 0.27, 'epa_rush_off': 0.09},
        'BUF': {'name': 'Buffalo Bills', 'epa_off': 0.17, 'epa_pass_off': 0.21, 'epa_rush_off': 0.10},
        'DAL': {'name': 'Dallas Cowboys', 'epa_off': 0.16, 'epa_pass_off': 0.20, 'epa_rush_off': 0.08},
        'DET': {'name': 'Detroit Lions', 'epa_off': 0.15, 'epa_pass_off': 0.33, 'epa_rush_off': -0.04},
        'GB': {'name': 'Green Bay Packers', 'epa_off': 0.15, 'epa_pass_off': 0.28, 'epa_rush_off': 0.0},
        'KC': {'name': 'Kansas City Chiefs', 'epa_off': 0.13, 'epa_pass_off': 0.11, 'epa_rush_off': 0.14},
        'WAS': {'name': 'Washington Commanders', 'epa_off': 0.10, 'epa_pass_off': 0.09, 'epa_rush_off': 0.11},
        'TB': {'name': 'Tampa Bay Buccaneers', 'epa_off': 0.10, 'epa_pass_off': 0.17, 'epa_rush_off': -0.03},
        'SEA': {'name': 'Seattle Seahawks', 'epa_off': 0.09, 'epa_pass_off': 0.29, 'epa_rush_off': -0.12},
        'NE': {'name': 'New England Patriots', 'epa_off': 0.08, 'epa_pass_off': 0.21, 'epa_rush_off': -0.13},
        'BAL': {'name': 'Baltimore Ravens', 'epa_off': 0.05, 'epa_pass_off': 0.07, 'epa_rush_off': 0.03},
        'DEN': {'name': 'Denver Broncos', 'epa_off': 0.05, 'epa_pass_off': 0.08, 'epa_rush_off': 0.01},
        'LA': {'name': 'Los Angeles Rams', 'epa_off': 0.04, 'epa_pass_off': 0.18, 'epa_rush_off': -0.18},
        'MIA': {'name': 'Miami Dolphins', 'epa_off': 0.04, 'epa_pass_off': 0.08, 'epa_rush_off': -0.04},
        'HOU': {'name': 'Houston Texans', 'epa_off': 0.04, 'epa_pass_off': 0.04, 'epa_rush_off': 0.03},
        'JAX': {'name': 'Jacksonville Jaguars', 'epa_off': 0.03, 'epa_pass_off': 0.01, 'epa_rush_off': 0.05},
        'SF': {'name': 'San Francisco 49ers', 'epa_off': 0.02, 'epa_pass_off': 0.13, 'epa_rush_off': -0.14},
        'PHI': {'name': 'Philadelphia Eagles', 'epa_off': 0.01, 'epa_pass_off': -0.02, 'epa_rush_off': 0.05},
        'PIT': {'name': 'Pittsburgh Steelers', 'epa_off': 0.01, 'epa_pass_off': 0.06, 'epa_rush_off': -0.05},
        'ARI': {'name': 'Arizona Cardinals', 'epa_off': -0.01, 'epa_pass_off': 0.03, 'epa_rush_off': -0.06},
        'NYJ': {'name': 'New York Jets', 'epa_off': -0.01, 'epa_pass_off': 0.03, 'epa_rush_off': -0.07},
        'CHI': {'name': 'Chicago Bears', 'epa_off': -0.02, 'epa_pass_off': 0.07, 'epa_rush_off': -0.15},
        'CAR': {'name': 'Carolina Panthers', 'epa_off': -0.02, 'epa_pass_off': -0.08, 'epa_rush_off': 0.06},
        'ATL': {'name': 'Atlanta Falcons', 'epa_off': -0.03, 'epa_pass_off': -0.02, 'epa_rush_off': -0.03},
        'LAC': {'name': 'Los Angeles Chargers', 'epa_off': -0.03, 'epa_pass_off': -0.04, 'epa_rush_off': -0.01},
        'NO': {'name': 'New Orleans Saints', 'epa_off': -0.06, 'epa_pass_off': -0.07, 'epa_rush_off': -0.03},
        'MIN': {'name': 'Minnesota Vikings', 'epa_off': -0.06, 'epa_pass_off': -0.05, 'epa_rush_off': -0.09},
        'LV': {'name': 'Las Vegas Raiders', 'epa_off': -0.13, 'epa_pass_off': -0.09, 'epa_rush_off': -0.17},
        'NYG': {'name': 'New York Giants', 'epa_off': -0.15, 'epa_pass_off': -0.17, 'epa_rush_off': -0.09},
        'CLE': {'name': 'Cleveland Browns', 'epa_off': -0.16, 'epa_pass_off': -0.27, 'epa_rush_off': 0.02},
        'TEN': {'name': 'Tennessee Titans', 'epa_off': -0.21, 'epa_pass_off': -0.25, 'epa_rush_off': -0.13},
        'CIN': {'name': 'Cincinnati Bengals', 'epa_off': -0.24, 'epa_pass_off': -0.30, 'epa_rush_off': -0.10},
    }
