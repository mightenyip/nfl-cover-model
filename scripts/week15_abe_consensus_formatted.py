#!/usr/bin/env python3
"""
Week 15 Consensus Predictions for Models A, B, and E - Formatted with Favorite/Underdog
"""
...
def main():
    ...
    df = pd.read_csv("week15_abe_consensus_predictions.csv")
    ...
    # Save to CSV
    output_file = "week15_abe_consensus_formatted.csv"
    result_df.to_csv(output_file, index=False)
    
    # Print formatted summary
    print("="*80)
    print("WEEK 15 CONSENSUS PREDICTIONS: MODELS A, B, E")
