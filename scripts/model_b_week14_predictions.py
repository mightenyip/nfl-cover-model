...
def main():
    """Main function"""
    print("=== Model B Week 14 Predictions ===")
    ...
    output_file = "models/model_b/model_b_week14_predictions.csv"
    ...
    print(f"=== Model B Week 14 Summary ===")
    ...
    print(f"\n✅ Model B Week 14 predictions saved to {output_file}")
