...
def combine_week1_week7_ats():
    ...
    week7_df = pd.read_csv("data/week7_ats_results.csv")
    week7_df['week'] = 7
    ...
    output_file = "data/combined_week1_week7_ats.csv"
...
def main():
    ...
    print(f"📁 Results saved to data/combined_week1_week7_ats.csv")
