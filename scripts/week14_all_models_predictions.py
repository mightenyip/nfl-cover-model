#!/usr/bin/env python3
"""
Week 14 All Models Predictions Comparison
Combine predictions from all models for Week 14
"""
...
def load_all_predictions():
    ...
    # Model A
    try:
        model_a = pd.read_csv("models/model_a/model_a_week14_predictions.csv")
    ...
    # Model B
    try:
        model_b = pd.read_csv("models/model_b/model_b_week14_predictions.csv")
    ...
    # Model C
    try:
        model_c = pd.read_csv("models/model_c/model_c_week14_predictions.csv")
    ...
    # Model D
    try:
        model_d = pd.read_csv("models/model_d/model_d_week14_predictions.csv")
    ...
    # Model E
    try:
        model_e = pd.read_csv("models/model_e/model_e_week14_predictions.csv")
...
def create_comparison(predictions):
    ...
    print("\n=== Creating Week 14 All Models Comparison ===")
...
def main():
    ...
    # Save comparison
    output_file = "week14_all_models_predictions.csv"
    ...
    print(f"\n✅ Week 14 all models comparison saved to {output_file}")
