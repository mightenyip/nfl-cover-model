#!/usr/bin/env python3
"""
Week 15 All Models Predictions Comparison
Combine predictions from all models for Week 15
"""
...
def load_all_predictions():
    ...
    # Model A
    try:
        model_a = pd.read_csv("models/model_a/model_a_week15_predictions.csv")
    ...
    # Model B
    try:
        model_b = pd.read_csv("models/model_b/model_b_week15_predictions.csv")
    ...
    # Model C
    try:
        model_c = pd.read_csv("models/model_c/model_c_week15_predictions.csv")
    ...
    # Model D
    try:
        model_d = pd.read_csv("models/model_d/model_d_week15_predictions.csv")
    ...
    # Model E
    try:
        model_e = pd.read_csv("models/model_e/model_e_week15_predictions.csv")
...
def create_comparison(predictions):
    ...
    print("\n=== Creating Week 15 All Models Comparison ===")
...
def main():
    ...
    print("="*80)
    print("WEEK 15 2025: ALL MODELS PREDICTIONS COMPARISON")
    print("="*80)
    ...
    # Save comparison
    output_file = "week15_all_models_predictions.csv"
    comparison_df.to_csv(output_file, index=False)
    print(f"\n✅ Saved comparison to {output_file}")
    
    # Summary statistics
    print("\n" + "="*80)
    print("WEEK 15 PREDICTIONS SUMMARY")
    print("="*80)
    ...
    print(f"\n✅ Week 15 all models comparison saved to {output_file}")
