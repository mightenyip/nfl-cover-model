...
def create_comprehensive_epa_data():
    ...
    offensive_data = {
        ...
        'epa_off_per_pass': [0.27, 0.31, 0.22, 0.17, 0.21, 0.23, 0.26, 0.09, 0.08, 0.09, 0.18, 0.04, 0.07, 0.05, 0.05, 0.07, -0.04, -0.02, -0.05, -0.04, -0.10, -0.10, -0.07, -0.09, -0.17, -0.12, -0.27, -0.26],
        'epa_off_per_rush': [0.16, 0.01, 0.07, 0.13, 0.01, -0.03, -0.13, 0.05, 0.04, -0.01, -0.16, 0.01, -0.05, -0.03, -0.03, -0.11, 0.05, 0.00, -0.02, -0.05, 0.01, 0.05, -0.05, -0.14, -0.08, -0.26, -0.02, -0.11],
        'pass_yards_off': [2071, 1798, 2099, 1614, 2168, 1634, 2038, 1803, 1677, 1501, 1866, 2184, 1663, 1919, 1773, 2183, 1620, 1611, 1770, 1472, 1581, 1730, 1611, 1591, 1733, 1425, 1517, 1615],
        'comp_pct_off': [0.7016, 0.7089, 0.6702, 0.6749, 0.7023, 0.75, 0.75, 0.6281, 0.7023, 0.6857, 0.6584, 0.68, 0.6195, 0.6394, 0.6364, 0.6589, 0.5869, 0.6867, 0.5945, 0.6371, 0.6245, 0.6364, 0.6223, 0.6393, 0.6621, 0.6618, 0.5894, 0.5766],
        'pass_td_off': [13, 13, 17, 12, 17, 16, 15, 15, 15, 16, 17, 16, 9, 13, 9, 12, 9, 15, 11, 9, 12, 15, 5, 9, 8, 7, 7, 5],
        'rush_yards_off': [1075, 799, 1012, 1151, 963, 936, 901, 1102, 893, 660, 724, 985, 872, 785, 788, 715, 838, 788, 944, 1149, 1095, 663, 863, 657, 749, 656, 716, 643],
        'rush_td_off': [18, 9, 9, 13, 10, 10, 7, 10, 9, 3, 4, 3, 7, 6, 4, 3, 6, 4, 10, 6, 4, 5, 7, 5, 3, 3, 6, 3],
        'adot_off': [8.69, 8.01, 7.89, 7.88, 7.38, 6.84, 8.25, 7.67, 9.10, 6.48, 8.90, 7.82, 8.51, 8.83, 7.36, 7.83, 8.31, 6.82, 9.50, 7.38, 7.36, 7.42, 8.26, 7.93, 8.33, 7.02, 7.00, 8.35],
        'sack_pct_off': [0.0333, 0.0426, 0.0424, 0.0579, 0.0311, 0.0588, 0.0976, 0.0259, 0.0977, 0.0529, 0.0428, 0.0669, 0.0474, 0.0561, 0.0609, 0.0492, 0.0683, 0.0652, 0.0820, 0.1023, 0.0648, 0.0609, 0.0395, 0.1077, 0.0608, 0.0826, 0.0608, 0.1069],
        'scramble_pct_off': [0.0481, 0.0511, 0.1030, 0.1033, 0.0404, 0.0181, 0.1080, 0.0518, 0.0625, 0.0220, 0.0117, 0.0610, 0.0593, 0.0561, 0.0326, 0.0308, 0.0478, 0.0326, 0.0852, 0.1155, 0.0444, 0.0224, 0.0395, 0.05, 0.0578, 0.0304, 0.0213, 0.0314],
        'int_pct_off': [0.0111, 0.0085, 0.0121, 0.0165, 0.0186, 0.0136, 0.0105, 0.0162, 0.0039, 0.0220, 0.0078, 0.0203, 0.0158, 0.0066, 0.0362, 0.0277, 0.0171, 0.0362, 0.0197, 0.0099, 0.0205, 0.0256, 0.0119, 0.0308, 0.0213, 0.0435, 0.0243, 0.0189]
    }
