#!/usr/bin/env python3
"""
Week 13 Consensus Predictions for Models A, B, and E - Formatted with Favorite/Underdog
"""
...
def main():
    ...
    df = pd.read_csv("week13_abe_consensus_predictions.csv")
    ...
    # Save to CSV
    output_file = "week13_abe_consensus_formatted.csv"
