...
def run_model_b_v2_week5():
    ...
    week5_data['underdog_total_advantage'] = (week5_data['underdog_pass_advantage'] * NFL_AVG_PASS_RATE) + (week5_data['underdog_rush_advantage'] * NFL_AVG_RUN_RATE)
    week5_data['favorite_total_advantage'] = (week5_data['favorite_pass_advantage'] * NFL_AVG_PASS_RATE) + (week5_data['favorite_rush_advantage'] * NFL_AVG_RUN_RATE)
