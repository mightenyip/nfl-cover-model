#!/usr/bin/env python3
"""
Model D Week 5: Total Rules Predictions
"""
...
def run_model_d_week5():
    """Run Model D for Week 5 using total-based rules"""
    
    print("=== Week 5 Model D: Total Rules Predictions ===")
    ...
    print(f"\n=== Week 5 Model D Predictions ===")
    
    # Show predictions grouped by rule
    for rule in week5_data['rule_applied'].unique():
    ...
    # Save predictions
    week5_data.to_csv("model_d_week5_predictions.csv", index=False)
    print(f"\n✅ Model D Week 5 predictions saved to: model_d_week5_predictions.csv")
