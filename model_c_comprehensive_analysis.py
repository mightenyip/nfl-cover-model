#!/usr/bin/env python3
"""
Model C Comprehensive Performance Analysis
Analyzes Model C performance from Week 2 onward through Week 7
"""

import pandas as pd
import numpy as np

def analyze_model_c_comprehensive():
    """Analyze Model C performance from Week 2 through Week 7"""
    
    print("=== Model C Comprehensive Performance Analysis ===")
    print("Analyzing Model C performance from Week 2 through Week 7")
    print("=" * 70)
    
    # Week 2 data (from previous analysis)
    week2_data = {
        'Seahawks @ Cardinals': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 1.5},
        ...
        'Eagles @ Buccaneers': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 3.5},
        'Colts @ Rams': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 3.5},
        ...
        'Jets @ Dolphins': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 2.5},
        'Bengals @ Broncos': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 7.0}
    }
    
    # Week 3 data (from actual results)
    week3_data = {
        'Dolphins @ Bills': {'prediction': 'Cover', 'underdog_covered': True, 'correct': True, 'spread': 12.5},
        'Falcons @ Panthers': {'prediction': 'No Cover', 'underdog_covered': True, 'correct': False, 'spread': 5.5},
        'Packers @ Browns': {'prediction': 'Cover', 'underdog_covered': True, 'correct': True, 'spread': 8.5},
        'Texans @ Jaguars': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 1.5},
        'Bengals @ Vikings': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 3.0},
        'Steelers @ Patriots': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 1.5},
        'Rams @ Eagles': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 3.5},
        'Jets @ Buccaneers': {'prediction': 'Cover', 'underdog_covered': True, 'correct': True, 'spread': 7.0},
        'Colts @ Titans': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 3.5},
        'Raiders @ Commanders': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 3.5},
        'Broncos @ Chargers': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 2.5},
        'Saints @ Seahawks': {'prediction': 'Cover', 'underdog_covered': False, 'correct': False, 'spread': 7.5},
        'Cowboys @ Bears': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 1.5},
        'Cardinals @ 49ers': {'prediction': 'No Cover', 'underdog_covered': True, 'correct': False, 'spread': 1.5},
        'Chiefs @ Giants': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 6.5},
        'Lions @ Ravens': {'prediction': 'Cover', 'underdog_covered': True, 'correct': True, 'spread': 5.5}
    }
    
    # Week 4 data (from previous analysis)
    week4_data = {
        'Seahawks @ Cardinals': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 1.5},
        'Vikings @ Steelers': {'prediction': 'Cover', 'underdog_covered': True, 'correct': True, 'spread': 2.5},
        'Commanders @ Falcons': {'prediction': 'Cover', 'underdog_covered': True, 'correct': True, 'spread': 1.5},
    ...
    # Week 5 data (from previous analysis)
    week5_data = {
        '49ers @ Rams': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 5.5},
        'Vikings @ Browns': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 3.5},
        'Texans @ Ravens': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 2.5},
        ...
        'Broncos @ Eagles': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 3.5},
        'Titans @ Cardinals': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 8.5},
        'Buccaneers @ Seahawks': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 3.5},
        'Lions @ Bengals': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 10.5},
        'Commanders @ Chargers': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 2.5},
        'Patriots @ Bills': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 8.0},
        'Chiefs @ Jaguars': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 3.5}
    }
    
    # Week 6 data (from previous analysis)
    week6_data = {
    ...
    # Week 7 data (from our analysis)
    week7_data = {
        'Steelers @ Bengals': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 5.5},
        'Rams @ Jaguars': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 3.0},
        'Saints @ Bears': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 5.5},
        'Dolphins @ Browns': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 2.5},
        'Patriots @ Titans': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 7.0},
        'Raiders @ Chiefs': {'prediction': 'Cover', 'underdog_covered': False, 'correct': False, 'spread': 11.5},
        'Eagles @ Vikings': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 2.5},
        'Panthers @ Jets': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 1.5},
        'Giants @ Broncos': {'prediction': 'Cover', 'underdog_covered': True, 'correct': True, 'spread': 7.0},
        'Colts @ Chargers': {'prediction': 'No Cover', 'underdog_covered': True, 'correct': False, 'spread': 1.5},
        'Commanders @ Cowboys': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 2.5},
        'Packers @ Cardinals': {'prediction': 'No Cover', 'underdog_covered': True, 'correct': False, 'spread': 6.5},
        'Falcons @ 49ers': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 2.5},
        'Buccaneers @ Lions': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 4.5},
        'Texans @ Seahawks': {'prediction': 'No Cover', 'underdog_covered': False, 'correct': True, 'spread': 3.5}
    }
    ...
    # Overall 6-week analysis
    print(f"\n=== OVERALL 6-WEEK ANALYSIS (Week 2-7) ===")
    ...
    for week, stats in weekly_stats.items():
        ...
        print(f"{week}: {stats['underdog_cover_rate']:.1f}% underdog cover rate {trend} | Model: {stats['accuracy']:.1f}%")
    
    # Performance by prediction type
    print(f"\n=== PERFORMANCE BY PREDICTION TYPE ===")
    print(f"'Cover' Predictions: {cover_accuracy:.1f}% accuracy")
    print(f"  - When Model C predicted underdog cover: {total_cover_underdog_covers}/{total_cover_predictions} actually covered ({total_cover_underdog_covers/total_cover_predictions*100:.1f}%)")
    print(f"'No Cover' Predictions: {no_cover_accuracy:.1f}% accuracy")
    print(f"  - When Model C predicted favorite cover: {total_no_cover_underdog_covers}/{total_no_cover_predictions} underdogs actually covered ({total_no_cover_underdog_covers/total_no_cover_predictions*100:.1f}%)")
    
    # Key insights
    print(f"\n=== KEY INSIGHTS (6 Weeks) ===")
    ...
    # Model C strengths and weaknesses
    print(f"\n=== MODEL C STRENGTHS & WEAKNESSES ===")
    if no_cover_accuracy > cover_accuracy:
        print("✅ STRENGTH: Better at identifying when favorites will cover")
        print("❌ WEAKNESS: Struggles to identify when underdogs will cover")
    elif cover_accuracy > no_cover_accuracy:
        print("✅ STRENGTH: Better at identifying when underdogs will cover")
        print("❌ WEAKNESS: Struggles to identify when favorites will cover")
    else:
        print("⚖️ BALANCED: Similar accuracy for both prediction types")
    
    # Compare with other models
    print(f"\n=== COMPARISON WITH OTHER MODELS ===")
    print(f"Model A Overall Accuracy: 52.7%")
    print(f"Model B Overall Accuracy: 46.7%")
    print(f"Model C Overall Accuracy: {overall_accuracy:.1f}%")
    
    if overall_accuracy > 52.7:
        print("✅ Model C outperformed Model A")
    elif overall_accuracy < 46.7:
        print("❌ Model C underperformed Model B")
    elif overall_accuracy > 46.7:
        print("✅ Model C outperformed Model B")
    else:
        print("⚖️ Model C performed similarly to other models")
    
    # Model C's unique approach analysis
    print(f"\n=== MODEL C'S UNIQUE APPROACH ===")
    print("Model C uses spread-based rules rather than EPA analysis")
    print("This approach appears to be more balanced between underdog and favorite predictions")
    
    if abs(cover_accuracy - no_cover_accuracy) < 10:
        print("✅ Model C shows balanced performance between prediction types")
    else:
        print("⚠️ Model C shows bias toward one prediction type")
    
    return weekly_stats

if __name__ == "__main__":
    analyze_model_c_comprehensive()
